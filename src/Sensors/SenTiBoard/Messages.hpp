...
#ifndef SENSORS_SENTIBOARD_MESSAGES_HPP_INCLUDED_
#define SENSORS_SENTIBOARD_MESSAGES_HPP_INCLUDED_
...
namespace Sensors
{
  namespace SenTiBoard
  {
    ...
    class HMR: public SenTiBoard::Message
    {
    public:
        ...
        HMR(const SenTiBoard::Packet* pkt)
        {
    ...
    class ADIS: public SenTiBoard::Message
    {
    public:
      float temperature;
    ...
    class uBlox: public SenTiBoard::Message
    {
    public:
      uint16_t id;
      ...
      uBlox(const SenTiBoard::Packet* pkt)
      {
        readTimes(pkt->data, 12);
        deserializeFields(pkt->data + 12, pkt->getLength() - 12);
      }
    ...
    public:
      ...
      Pulse(const SenTiBoard::Packet* pkt)
      {
        readTimes(pkt->data, 12);
      }
    ...
    class STIM: public SenTiBoard::Message
    {
    public:
