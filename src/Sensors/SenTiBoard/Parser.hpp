...
#ifndef SENSORS_SENTIBOARD_PARSER_HPP_INCLUDED_
#define SENSORS_SENTIBOARD_PARSER_HPP_INCLUDED_
      ...
      parse(uint8_t byte)
      {
        switch (m_state)
        {
          ...
          case PS_LEN2:
            ...
            m_length = SENTIBOARD_GET_UINT16_AT(m_packet.header, 2);
