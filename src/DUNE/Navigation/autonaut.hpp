...
namespace DUNE
{
  namespace Navigation
  {
    ...
    class autonaut
    {
      ...
      void linearPrediction(const std::vector<double>& state, double u_d, double psi_d, const Eigen::Matrix<double,-1,2>&waypoints, double Chi_ca, int course_change_point, int guidance_strategy, double R, double de, double Ki);
