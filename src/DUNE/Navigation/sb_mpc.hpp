...
namespace DUNE
{
  namespace Navigation
  {
	...
	void getBestControlOffset(double &u_os_best, double &psi_os_best, double u_d, double psi_d, const std::vector<double>& asv_state, const Eigen::Matrix<double,-1,2>& waypoints, const Math::Matrix& obst_states, Math::Matrix static_obst_states, double &cost_mra);
	...
	double costFunction(double P_ca, double Chi_ca, int k, bool SB_0, bool CRG_0, bool OTG_0, bool OT_0, bool HOT_0, double DIST_0, double u_d, int l, int &ik_return_to_path, Math::Matrix obst_state, Math::Matrix static_obst_state, int chi_ca_itr); //Eigen::Matrix<double,1,4> static_obst 
