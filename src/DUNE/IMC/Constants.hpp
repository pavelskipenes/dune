...
#define DUNE_IMC_CONST_GIT_INFO "2022-06-27 fcec5cb  (HEAD -> AutoNaut, upstream/master, origin/master, origin/HEAD, master)"
//! MD5 sum of XML specification file.
#define DUNE_IMC_CONST_MD5 "22739cefb8195d9946816920d152d5e8"
