...
namespace DUNE
{
  namespace IMC
  {
    ...
    PowerSettings::PowerSettings(void)
    {
      m_header.mgid = 912;
      clear();
    }
    ...
    bool
    PowerSettings::fieldsEqual(const Message& msg__) const
    {
      const IMC::PowerSettings& other__ = static_cast<const PowerSettings&>(msg__);
      if (l2 != other__.l2) return false;
      if (l3 != other__.l3) return false;
      if (iridium != other__.iridium) return false;
      if (modem != other__.modem) return false;
      if (pumps != other__.pumps) return false;
      if (vhf != other__.vhf) return false;
      return true;
    }

    int
    PowerSettings::validate(void) const
    {
      return true;
    }

    uint8_t*
    PowerSettings::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(l2, ptr__);
      ptr__ += IMC::serialize(l3, ptr__);
      ptr__ += IMC::serialize(iridium, ptr__);
      ptr__ += IMC::serialize(modem, ptr__);
      ptr__ += IMC::serialize(pumps, ptr__);
      ptr__ += IMC::serialize(vhf, ptr__);
      return ptr__;
    }

    uint16_t
    PowerSettings::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(l2, bfr__, size__);
      bfr__ += IMC::deserialize(l3, bfr__, size__);
      bfr__ += IMC::deserialize(iridium, bfr__, size__);
      bfr__ += IMC::deserialize(modem, bfr__, size__);
      bfr__ += IMC::deserialize(pumps, bfr__, size__);
      bfr__ += IMC::deserialize(vhf, bfr__, size__);
      return bfr__ - start__;
    }

    uint16_t
    PowerSettings::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(l2, bfr__, size__);
      bfr__ += IMC::deserialize(l3, bfr__, size__);
    ...
    void
    PowerSettings::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "l2", l2, nindent__);
      IMC::toJSON(os__, "l3", l3, nindent__);
      IMC::toJSON(os__, "iridium", iridium, nindent__);
    ...
    bool
    CasCost::fieldsEqual(const Message& msg__) const
    {
      const IMC::CasCost& other__ = static_cast<const CasCost&>(msg__);
      if (value != other__.value) return false;
      return true;
    }

    int
    CasCost::validate(void) const
    {
      return true;
    }

    uint8_t*
    CasCost::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(value, ptr__);
      return ptr__;
    ...
    uint16_t
    CasCost::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    uint16_t
    CasCost::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(value, bfr__, size__);
      return bfr__ - start__;
    ...
    fp64_t
    CasCost::getValueFP(void) const
    {
      return static_cast<fp64_t>(value);
    }

    void
    CasCost::setValueFP(fp64_t val)
    {
      value = static_cast<fp64_t>(val);
    }

    void
    CasCost::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "value", value, nindent__);
    }
    ...
    bool
    AisGpsFix::fieldsEqual(const Message& msg__) const
    {
      const IMC::AisGpsFix& other__ = static_cast<const AisGpsFix&>(msg__);
      if (validity != other__.validity) return false;
      if (type != other__.type) return false;
      if (utc_year != other__.utc_year) return false;
      if (utc_month != other__.utc_month) return false;
    ...
    uint8_t*
    AisGpsFix::serializeFields(uint8_t* bfr__) const
    {
      uint8_t* ptr__ = bfr__;
      ptr__ += IMC::serialize(validity, ptr__);
      ptr__ += IMC::serialize(type, ptr__);
    ...
    uint16_t
    AisGpsFix::deserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::deserialize(validity, bfr__, size__);
      bfr__ += IMC::deserialize(type, bfr__, size__);
    ...
    uint16_t
    AisGpsFix::reverseDeserializeFields(const uint8_t* bfr__, uint16_t size__)
    {
      const uint8_t* start__ = bfr__;
      bfr__ += IMC::reverseDeserialize(validity, bfr__, size__);
      bfr__ += IMC::deserialize(type, bfr__, size__);
    ...
    void
    AisGpsFix::fieldsToJSON(std::ostream& os__, unsigned nindent__) const
    {
      IMC::toJSON(os__, "validity", validity, nindent__);
      IMC::toJSON(os__, "type", type, nindent__);
      IMC::toJSON(os__, "utc_year", utc_year, nindent__);
