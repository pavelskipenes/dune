...
#define DUNE_VERSION_STR "2019.02.1"
//! DUNE's version year.
#define DUNE_VERSION_YEAR 2019
//! DUNE's version month.
#define DUNE_VERSION_MONTH 02
//! DUNE's version patch level.
#define DUNE_VERSION_PATCH 1
//! DUNE's version release candidate number.
#define DUNE_VERSION_RCN 0
//! DUNE's copyright.
#define DUNE_COPYRIGHT "Copyright (C) 2007-2019 - Universidade do Porto - LSTS"
//! DUNE's contact.
#define DUNE_CONTACT "DUNE <dune@lsts.pt>"
//! DUNE's build type.
#define DUNE_BUILD_TYPE "Release"
//! DUNE's system name.
#define DUNE_SYSTEM_NAME "x86-64bit-linux-glibc-gcc54"
//! DUNE's source path.
#define DUNE_PATH_SRC "/home/autonaut/dune_all/dune"
//! DUNE's build path.
#define DUNE_PATH_BUILD "/home/autonaut/dune_all/dune"
